...
class TestData:
    ...
    #     self.yours = 0
    #     self.mine_puttables = []
    #     self.yours_puttables = []


    def __init__(self, p1 = 0, p2 = 0, expected = None):
        self.id = -1
        self.mine = p1
        self.yours = p2
...
def gen_test_data():
    ...
    d1 = TestData()
    d1.id = 0
    d1.mine  = board.BoardUtil.string_to_bit("0000010000100000")
    d1.yours = board.BoardUtil.string_to_bit("0000001001000000")
    d1.mine_puttables = [2,13,8,7]
    d1.yours_puttables = [1,14,4,11]

    data.append(d1)

    d1 = TestData()
    d1.id = 1
    d1.mine  = board.BoardUtil.string_to_bit("0000011000000000")
    d1.yours = board.BoardUtil.string_to_bit("0000000001100000")
    d1.mine_puttables = [12,13,14,15]
    d1.yours_puttables = [0,1,2,3]
    ...
    d1 = TestData()
    d1.id = 3
    d1.mine  = 0b1000001000000
    d1.yours = 0b1110011100100000
    d1.mine_puttables = [4]
    d1.yours_puttables = [2,7]
